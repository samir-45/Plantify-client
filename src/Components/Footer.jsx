...
const Footer = () => {
    return (
        <div>
<footer className="footer footer-horizontal footer-center bg-[#172b17] text-green-100 p-10">
  <aside>
<h1 className='text-2xl font-bold'>PlantiFy</h1>
    <p className="font-bold">
      GREEN Industries Ltd.
      <br />
      Providing reliable plant services since 1992
    </p>
  </aside>
  <nav>
...
<footer className="footer sm:footer-horizontal footer-center bg-[#c4dea9] text-base-content p-4">
  <aside>
    <p>Copyright © {new Date().getFullYear()} - All right reserved by GREEN Industries Ltd</p>
  </aside>
</footer>
        </div>
    );
